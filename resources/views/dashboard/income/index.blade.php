...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pendapatan {{ auth()->user()->name }}</h1>
    </div>
    ...
    <div class="table-responsive col-lg-12">
        <a href="/dashboard/income/create" class="btn btn-primary mb-3 postition-relative"><i
                class="bi bi-file-earmark-plus"></i> Tambahkan
            data</a>
        <a href="/dashboard/income-pdf" class="btn btn-success mb-3" target="_blank"><i
        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th scope="col">Asal Pendapatan</th>
            ...
            <tbody>
                @foreach ($incomes as $income)
                    <tr>
                        ...
                        <td>{{ $income->notes }}</td>
                        <td>
                            <a href="/dashboard/income/{{ $income->id }}/edit"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="/dashboard/income/{{ $income->id }}" method="POST"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
